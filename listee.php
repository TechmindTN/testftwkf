...
$query2 ="SELECT saison from entraineur Group By saison order by saison";
...
<div class="container ">
           ...
           <div class="row" style="width:100%" >       <h1 class="h4 text-gray-900 mb-4" style=" width:100%">Exporter Entraineurs</h1></div>
            ...
            <div class="col-lg-12">
                        <div class="p-5">
<form name="stat" method="post" action="explistee.php">
        <div class="col-sm-4 mb-3 mb-sm-0">
        <strong>Saison</strong>     <select name="saison" class="custom-select">
                      <option>-</option>
                      <?php
					   do { 
                                     $res=$row2['saison'];
