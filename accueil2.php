...
if (($club == "ADMIN")or($club == "Admin")or($club == "admin")){ 
    $queryatt1 ="SELECT count(*) FROM athletes WHERE saison=(select saison from saison where actif='1')";
...
$resultatt4 = mysql_query($queryatt4,$connexion);
$rowatt4 = mysql_fetch_row($resultatt4);
...
<!-- <frameset cols="15%,*" frameborder="NO" border="0" framespacing="0">
  <frame src="sidebar.php" name="top1" target="main" ><frame src="corp.php" name="main" target="_self">
      ...
      <input type="submit" name="lang" value="ar" class="btn"/>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?php echo $club; ?> &nbsp;<?php echo $saison;?></h1>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $row2[0];
                                                    ?> </div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?=$_TXT[48]?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $rowatt4[0];
                                                    ?></div>
                                        </div>
                                        <div class="col-auto">
...
<div class="w3-content w3-display-container">
  <img class="mySlides" src="assets/img/slide/ff.jpg" style="width:100%">
  <img class="mySlides" src="assets/img/slide/ccc.jpg" style="width:100%">
  <img class="mySlides" src="assets/img/slide/qq.jpg" style="width:100%">
...
<p>La fédération Tunisienne de Wushu Kung Fu et Disciplines associées est une université sportive tunisienne fondée le 9 septembre 2005, supervisant le wushu kung fu et disciplines associées.</p>
                                </div>
                                <!-- Card Body -->
...
<p> Nous sommes spécialisés dans  kung fu, sanda, whushu, kempo ....</p>
                                </div>
                                <!-- Card Body -->
